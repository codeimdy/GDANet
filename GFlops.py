...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default='/media/hanyong/zgw/ZWD/DATA/COCO', type=str)
...
if __name__ == '__main__':
    ...
    model.to('cuda:0')
    url = r'/media/hanyong/zgw/ZWD/add_Deformable-DETR/exps/r50_deformable_detr/checkpoint0049.pth'
